    ...
    createPicker: function () {
        ...
        me.store.on('load', function (store) {
            if (store.getTotalCount() == 0) {
                ...
                if (me.noData && Ext.isFunction(me.noData)) me.noData.setStyle('display', 'block');
            }
            else {
                me.allSelectorHidden = false;
                if (me.allSelector != false) me.allSelector.setStyle('display', 'block');
                if (me.noData && Ext.isFunction(me.noData)) me.noData.setStyle('display', 'none');
            }
        });
