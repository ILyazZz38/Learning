Ext.define('B4.form.register.personalaccount.groupoperation.GenerateAvgAccountCounterConsumptionBy354ForRecalcPeriods', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me,
            {
                title: 'Генерация среднего ИПУ/ОКПУ за периоды перерасчета, установленные в тек. месяце (354 Пост.)',
                defaults: {
                    margin: 5
                },
                items: [
    ...
    onSave: function () {
        ...
        Ext.MessageBox.confirm('Внимание', 'Вы уверены, что хотите сгенерировать средний расход по приборам учета?', function (ans) {
            if (ans == 'yes') {
                ...
                B4.Ajax.request({
                    url: B4.Url.action('/Counter/CalculateAverageBy354ForRecalcPeriods'),
                    params: {
