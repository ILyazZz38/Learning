Ext.define('B4.form.register.personalaccount.groupoperation.GenerateAvgCounterConsumption', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me,
            {
                title: 'Настройка генерации среднего расхода ИПУ',
                defaults: {
                    margin: 5
                },
                items: [
    ...
    onLoad: function (view) {
        ...
        B4.Ajax.request({
            ...
            params: {
                houses: Ext.encode(view.personalAccount),
                personalCounter: true
            }
        }).next(function (resp) {
            viewEl.unmask();
